...
function initModels(sequelize) {
  ...
  coin_ledger.belongsTo(account, { as: "sender_account", foreignKey: "sender"});
  account.hasMany(coin_ledger, { as: "coin_ledgers", foreignKey: "sender"});
  coin_ledger.belongsTo(account, { as: "reciever_account", foreignKey: "reciever"});
  account.hasMany(coin_ledger, { as: "reciever_coin_ledgers", foreignKey: "reciever"});
