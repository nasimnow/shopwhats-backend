...
router.get("/count", (req, res) => {
  ...
  (select count(*) from catogories WHERE cat_user=${req.user.user.id} AND date) as cat_count ,(select store_views from store_analytics WHERE user_id=${req.user.user.id} AND date=${today}) as store_views,(select message_clicks from store_analytics WHERE user_id=${req.user.user.id} AND date=${today}) as message_clicks`;
